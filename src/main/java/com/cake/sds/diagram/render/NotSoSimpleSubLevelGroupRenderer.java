        ...
        try {
            ...
            for (final ClientSubLevel entitySubLevel : subLevels) {
                ...
                for (final Entity entity : entities) {
                    ...
                    ((LevelRendererAccessor) minecraft.levelRenderer).sds$renderEntity(entity, cameraPosition.x, cameraPosition.y, cameraPosition.z, partialTick, entityPoseStack, bufferSource);
                }
